...
export function FinancingAdvisorComponent() {
  ...
  const [activeSondertilgungen, setActiveSondertilgungen] = useState<Sondertilgung[]>([]);

  const openSondertilgungenModal = (sondertilgungen: Sondertilgung[]) => {
    setActiveSondertilgungen(sondertilgungen);
    setIsSondertilgungenModalOpen(true);
  };
  ...
  return (
    <>
                                      ...
                                      <>
                                        ...
                                        <div className="text-sm">
                                          ...
                                          <Button 
                                            ...
                                            onClick={() => openSondertilgungenModal(tranche.eingabe.sondertilgungen)}
                                          >
                                            Anzeigen
                                          </Button>
                                        </div>
      ...
      <SondertilgungenModal 
        ...
        sondertilgungen={activeSondertilgungen}
      />
    </>
  )
}